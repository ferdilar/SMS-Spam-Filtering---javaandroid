...
public class PromoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(br==true){
            ...
            Intent intent_to = new Intent(this, PromoActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PromoActivity.this, SmsActivity.class);
...
//                intent.putExtra("tag", "Sms");
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_promotion);
        ...
        navigationView.setNavigationItemSelectedListener(this);
         /*Ambil Data SMS*/
        ArrayList<Promo> arl_inbox = new ArrayList<Promo>();
        arl_inbox = fetchInbox();
        Promo[] promo_inbox = arl_inbox.toArray(new Promo[arl_inbox.size()]);
        list_promo = (ListView) findViewById(R.id.lv_promo_list);
        if (fetchInbox() != null) {
            PromoAdapter adapter = new PromoAdapter(this, R.layout.promo_row_listview, promo_inbox);
//            list_sms.addHeaderView(header);
            list_promo.setAdapter(adapter);
        }

        list_promo.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
...
//                String _id = ((TextView) arg1.findViewById(R.id.tv_id)).getText().toString();
        ...
        //akan filter data sari sms:inbox dari id inbox>=_id sharedPreferences
...
//            return true;
    ...
    public ArrayList<Promo> fetchInbox(){
        ArrayList<Promo> arl_sms_inbox = new ArrayList<Promo>();
        db_helper = new DBHelper(this);

        //load db_helper cek apakah _id terdapat dalam tabel spam_filter id_inbox?
        //atau pakai beetwen di query?
        final String[] projection = new String[]{"*"};
        Cursor cursor = db_helper.getSpam(0);
        String id_inbox="";
        ...
        if(c_sms_inbox.moveToFirst()){
            promo = getPromo(c_sms_inbox);
            arl_sms_inbox.add(promo);
    ...
    public Promo getPromo(Cursor c_promo_inbox){
        int _id=c_promo_inbox.getInt(0);//buat masuk conversation dikirim intent = id_thread
        String address=c_promo_inbox.getString(2);
        String body=c_promo_inbox.getString(12);
        int read=c_promo_inbox.getInt(7);

        Date date_long = new Date(c_promo_inbox.getLong(4));
        ...
        Promo promo = new Promo(address, body, datetime, read, _id);
